...
class PurchasReqController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.purchasReqs.index', compact('purchasReqs'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.purchasReqs.create');
    }
    ...
    public function store(StorePurchasReqRequest $request)
    {
        ...
        return redirect()->route('frontend.purchas-reqs.index');
    }
    ...
    public function edit(PurchasReq $purchasReq)
    {
        ...
        return view('frontend.purchasReqs.edit', compact('purchasReq'));
    }
    ...
    public function show(PurchasReq $purchasReq)
    {
        ...
        return view('frontend.purchasReqs.show', compact('purchasReq'));
    }
