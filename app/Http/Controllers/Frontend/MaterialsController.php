...
class MaterialsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.materials.index', compact('materials'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.materials.create');
    }
    ...
    public function store(StoreMaterialRequest $request)
    {
        ...
        return redirect()->route('frontend.materials.index');
    }
    ...
    public function edit(Material $material)
    {
        ...
        return view('frontend.materials.edit', compact('material'));
    }
