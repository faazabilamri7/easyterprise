...
class SalesInquiryController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.salesInquiries.create', compact('id_customers', 'id_products'));
    }
    ...
    public function edit(SalesInquiry $salesInquiry)
    {
        ...
        return view('frontend.salesInquiries.edit', compact('id_customers', 'id_products', 'salesInquiry'));
    }
