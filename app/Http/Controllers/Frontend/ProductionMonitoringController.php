...
class ProductionMonitoringController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.productionMonitorings.create', compact('production_plans'));
    }
    ...
    public function edit(ProductionMonitoring $productionMonitoring)
    {
        ...
        return view('frontend.productionMonitorings.edit', compact('productionMonitoring', 'production_plans'));
    }
