...
class StokProdukController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.stokProduks.index', compact('stokProduks'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.stokProduks.create');
    }
    ...
    public function store(StoreStokProdukRequest $request)
    {
        ...
        return redirect()->route('frontend.stok-produks.index');
    }
    ...
    public function edit(StokProduk $stokProduk)
    {
        ...
        return view('frontend.stokProduks.edit', compact('stokProduk'));
    }
    ...
    public function show(StokProduk $stokProduk)
    {
        ...
        return view('frontend.stokProduks.show', compact('stokProduk'));
    }
