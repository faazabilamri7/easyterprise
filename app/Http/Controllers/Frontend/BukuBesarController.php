...
class BukuBesarController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.bukuBesars.index', compact('bukuBesars'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.bukuBesars.create', compact('akuns'));
    }
    ...
    public function store(StoreBukuBesarRequest $request)
    {
        ...
        return redirect()->route('frontend.buku-besars.index');
    }
    ...
    public function edit(BukuBesar $bukuBesar)
    {
        ...
        return view('frontend.bukuBesars.edit', compact('akuns', 'bukuBesar'));
    }
    ...
    public function show(BukuBesar $bukuBesar)
    {
        ...
        return view('frontend.bukuBesars.show', compact('bukuBesar'));
    }
