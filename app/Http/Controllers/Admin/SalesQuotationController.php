...
class SalesQuotationController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.salesQuotations.create', compact('id_customers', 'id_sales_inquiries'));
    }
    ...
    public function edit(SalesQuotation $salesQuotation)
    {
        ...
        return view('admin.salesQuotations.edit', compact('id_customers', 'id_sales_inquiries', 'salesQuotation'));
    }
