...
class ProductionPlanController extends Controller
{
    public function index()
    {
        ...
        return view('admin.productionPlans.index', compact('productionPlans'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.productionPlans.create');
    }
    ...
    public function edit(ProductionPlan $productionPlan)
    {
        ...
        return view('admin.productionPlans.edit', compact('productionPlan'));
    }
    ...
    public function show(ProductionPlan $productionPlan)
    {
        ...
        return view('admin.productionPlans.show', compact('productionPlan'));
    }
