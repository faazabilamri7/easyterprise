...
class StokMaterialController extends Controller
{
    public function index()
    {
        ...
        return view('admin.stokMaterials.index', compact('stokMaterials'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.stokMaterials.create');
    }
    ...
    public function store(StoreStokMaterialRequest $request)
    {
        ...
        return redirect()->route('admin.stok-materials.index');
    }
    ...
    public function edit(StokMaterial $stokMaterial)
    {
        ...
        return view('admin.stokMaterials.edit', compact('stokMaterial'));
    }
    ...
    public function show(StokMaterial $stokMaterial)
    {
        ...
        return view('admin.stokMaterials.show', compact('stokMaterial'));
    }
