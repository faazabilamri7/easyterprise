...
class TransaksiKeuanganController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.transaksiKeuangans.create', compact('kas_banks', 'produks'));
    }
    ...
    public function edit(TransaksiKeuangan $transaksiKeuangan)
    {
        ...
        return view('admin.transaksiKeuangans.edit', compact('kas_banks', 'produks', 'transaksiKeuangan'));
    }
