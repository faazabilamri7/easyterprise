...
class PurchaseInqController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.purchaseInqs.create', compact('id_request_for_quotations'));
    }
    ...
    public function edit(PurchaseInq $purchaseInq)
    {
        ...
        return view('admin.purchaseInqs.edit', compact('id_request_for_quotations', 'purchaseInq'));
    }
