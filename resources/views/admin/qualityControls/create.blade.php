    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.quality-controls.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_quality_control') ? 'is-invalid' : '' }}" type="text" name="id_quality_control" id="id_quality_control" value="{{ old('id_quality_control', '') }}">
