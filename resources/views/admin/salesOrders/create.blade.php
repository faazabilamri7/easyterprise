    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sales-orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_sales_order') ? 'is-invalid' : '' }}" type="text" name="no_sales_order" id="no_sales_order" value="{{ old('no_sales_order', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('finance') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="finance" id="finance" value="1" {{ old('finance', 0) == 1 ? 'checked' : '' }}>
