    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sales-orders.update", [$salesOrder->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_sales_order') ? 'is-invalid' : '' }}" type="text" name="no_sales_order" id="no_sales_order" value="{{ old('no_sales_order', $salesOrder->no_sales_order) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_sales_quotation') ? 'is-invalid' : '' }}" name="id_sales_quotation_id" id="id_sales_quotation_id">
