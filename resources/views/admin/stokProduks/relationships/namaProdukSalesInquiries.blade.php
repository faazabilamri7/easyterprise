...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-namaProdukSalesInquiries">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($salesInquiries as $key => $salesInquiry)
                        <tr data-entry-id="{{ $salesInquiry->id }}">
                            ...
                            <td>
                                {{ $salesInquiry->nama_produk->produk_nama ?? '' }}
                            </td>
                            <td>
                                {{ $salesInquiry->qty ?? '' }}
                            </td>
...
@endcan
  ...
  let table = $('.datatable-namaProdukSalesInquiries:not(.ajaxTable)').DataTable({ buttons: dtButtons })
