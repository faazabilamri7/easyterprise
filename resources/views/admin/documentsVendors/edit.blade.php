...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.documents-vendors.update", [$documentsVendor->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
...
<script>
    ...
    url: '{{ route('admin.documents-vendors.storeMedia') }}',
    maxFilesize: 2, // MB
    maxFiles: 1,
    addRemoveLinks: true,
    headers: {
