    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.request-stock-products.update", [$requestStockProduct->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_request_product') ? 'is-invalid' : '' }}" type="text" name="id_request_product" id="id_request_product" value="{{ old('id_request_product', $requestStockProduct->id_request_product) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tanggal_request') ? 'is-invalid' : '' }}" type="text" name="tanggal_request" id="tanggal_request" value="{{ old('tanggal_request', $requestStockProduct->tanggal_request) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('request_product') ? 'is-invalid' : '' }}" name="request_product_id" id="request_product_id">
