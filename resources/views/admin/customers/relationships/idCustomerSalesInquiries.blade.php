...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-idCustomerSalesInquiries">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($salesInquiries as $key => $salesInquiry)
                        <tr data-entry-id="{{ $salesInquiry->id }}">
                            ...
                            <td>
                                {{ $salesInquiry->id_product->nama_produk ?? '' }}
                            </td>
                            <td>
                                {{ $salesInquiry->qty ?? '' }}
                            </td>
...
@endcan
  ...
  let table = $('.datatable-idCustomerSalesInquiries:not(.ajaxTable)').DataTable({ buttons: dtButtons })
