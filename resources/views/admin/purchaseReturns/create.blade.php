    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchase-returns.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_purchase_return') ? 'is-invalid' : '' }}" type="text" name="id_purchase_return" id="id_purchase_return" value="{{ old('id_purchase_return', '') }}">
