    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.sales-quotations.update", [$salesQuotation->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_sales_quotation') ? 'is-invalid' : '' }}" type="text" name="id_sales_quotation" id="id_sales_quotation" value="{{ old('id_sales_quotation', $salesQuotation->id_sales_quotation) }}">
