    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchase-quotations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nego_purchase_quotation') ? 'is-invalid' : '' }}" type="text" name="nego_purchase_quotation" id="nego_purchase_quotation" value="{{ old('nego_purchase_quotation', '') }}">
