    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchase-quotations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_purchase_quotation') ? 'is-invalid' : '' }}" type="text" name="id_purchase_quotation" id="id_purchase_quotation" value="{{ old('id_purchase_quotation', '') }}">
