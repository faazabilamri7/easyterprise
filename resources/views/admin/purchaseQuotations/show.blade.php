...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#id_purchase_quotation_purchase_orders" role="tab" data-toggle="tab">
                {{ trans('cruds.purchaseOrder.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="id_purchase_quotation_purchase_orders">
            @includeIf('admin.purchaseQuotations.relationships.idPurchaseQuotationPurchaseOrders', ['purchaseOrders' => $purchaseQuotation->idPurchaseQuotationPurchaseOrders])
        </div>
    </div>
</div>
