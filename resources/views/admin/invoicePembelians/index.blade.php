...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-InvoicePembelian">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.invoice-pembelians.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'nomor', name: 'nomor' },
{ data: 'tanggal', name: 'tanggal' },
{ data: 'perusahaan_nama_vendor', name: 'perusahaan.nama_vendor' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-InvoicePembelian').DataTable(dtOverrideGlobals);
