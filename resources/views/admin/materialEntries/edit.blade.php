    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.material-entries.update", [$materialEntry->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_material_entry') ? 'is-invalid' : '' }}" type="text" name="id_material_entry" id="id_material_entry" value="{{ old('id_material_entry', $materialEntry->id_material_entry) }}">
