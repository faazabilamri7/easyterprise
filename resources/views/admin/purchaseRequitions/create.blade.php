    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchase-requitions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_purchase_requition') ? 'is-invalid' : '' }}" type="text" name="id_purchase_requition" id="id_purchase_requition" value="{{ old('id_purchase_requition', '') }}">
