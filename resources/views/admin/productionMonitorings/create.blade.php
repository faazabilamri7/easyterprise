    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.production-monitorings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_production_monitoring') ? 'is-invalid' : '' }}" type="text" name="id_production_monitoring" id="id_production_monitoring" value="{{ old('id_production_monitoring', '') }}">
