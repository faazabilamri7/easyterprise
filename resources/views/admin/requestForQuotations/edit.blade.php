...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.request-for-quotations.update", [$requestForQuotation->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="id_purchase_requisition">{{ trans('cruds.requestForQuotation.fields.id_purchase_requisition') }}</label>
                <input class="form-control {{ $errors->has('id_purchase_requisition') ? 'is-invalid' : '' }}" type="number" name="id_purchase_requisition" id="id_purchase_requisition" value="{{ old('id_purchase_requisition', $requestForQuotation->id_purchase_requisition) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_company') ? 'is-invalid' : '' }}" type="number" name="id_company" id="id_company" value="{{ old('id_company', $requestForQuotation->id_company) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('quantity') ? 'is-invalid' : '' }}" type="number" name="quantity" id="quantity" value="{{ old('quantity', $requestForQuotation->quantity) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $requestForQuotation->status) }}">
