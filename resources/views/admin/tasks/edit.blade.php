    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tasks.update", [$task->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_production_plan') ? 'is-invalid' : '' }}" type="text" name="id_production_plan" id="id_production_plan" value="{{ old('id_production_plan', $task->id_production_plan) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_request_product') ? 'is-invalid' : '' }}" name="id_request_product_id" id="id_request_product_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_mesin') ? 'is-invalid' : '' }}" name="id_mesin_id" id="id_mesin_id">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_name') ? 'is-invalid' : '' }}" name="product_name_id" id="product_name_id" required>
                    @foreach($product_names as $id => $entry)
                        <option value="{{ $id }}" {{ (old('product_name_id') ? old('product_name_id') : $task->product_name->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty') ? 'is-invalid' : '' }}" type="number" name="qty" id="qty" value="{{ old('qty', $task->qty) }}" step="1" required>
                @if($errors->has('qty'))
                    <div class="invalid-feedback">
                        {{ $errors->first('qty') }}
                    </div>
