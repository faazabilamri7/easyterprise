...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.production-plans.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('durasi') ? 'is-invalid' : '' }}" type="text" name="durasi" id="durasi" value="{{ old('durasi', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rincian') ? 'is-invalid' : '' }}" type="text" name="rincian" id="rincian" value="{{ old('rincian', '') }}">
