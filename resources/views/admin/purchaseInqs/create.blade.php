    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchase-inqs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_purchase_inquiry') ? 'is-invalid' : '' }}" type="text" name="date_purchase_inquiry" id="date_purchase_inquiry" value="{{ old('date_purchase_inquiry') }}">
