...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-idPurchaseInquiryVendors">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($vendors as $key => $vendor)
                        <tr data-entry-id="{{ $vendor->id }}">
                            ...
                            <td>
                                {{ $vendor->id_purchase_inquiry->id_list_of_material ?? '' }}
                            </td>
                            <td>
                                {{ $vendor->nama_vendor ?? '' }}
                            </td>
...
@endcan
  ...
  let table = $('.datatable-idPurchaseInquiryVendors:not(.ajaxTable)').DataTable({ buttons: dtButtons })
