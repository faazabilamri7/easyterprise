    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchase-inqs.update", [$purchaseInq->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_purchase_inquiry') ? 'is-invalid' : '' }}" type="text" name="id_purchase_inquiry" id="id_purchase_inquiry" value="{{ old('id_purchase_inquiry', $purchaseInq->id_purchase_inquiry) }}">
