    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchase-inqs.update", [$purchaseInq->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_purchase_inquiry') ? 'is-invalid' : '' }}" type="text" name="id_purchase_inquiry" id="id_purchase_inquiry" value="{{ old('id_purchase_inquiry', $purchaseInq->id_purchase_inquiry) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_request_for_quotation') ? 'is-invalid' : '' }}" name="id_request_for_quotation_id" id="id_request_for_quotation_id" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('vendor_name') ? 'is-invalid' : '' }}" name="vendor_name_id" id="vendor_name_id" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_puchase_inquiry') ? 'is-invalid' : '' }}" type="text" name="date_puchase_inquiry" id="date_puchase_inquiry" value="{{ old('date_puchase_inquiry', $purchaseInq->date_puchase_inquiry) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('material_name') ? 'is-invalid' : '' }}" name="material_name_id" id="material_name_id">
                    @foreach($material_names as $id => $entry)
                        <option value="{{ $id }}" {{ (old('material_name_id') ? old('material_name_id') : $purchaseInq->material_name->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty') ? 'is-invalid' : '' }}" type="number" name="qty" id="qty" value="{{ old('qty', $purchaseInq->qty) }}" step="1">
                @if($errors->has('qty'))
                    <div class="invalid-feedback">
                        {{ $errors->first('qty') }}
                    </div>
