    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transfer-produks.update", [$transferProduk->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_transfer_produk') ? 'is-invalid' : '' }}" type="text" name="id_transfer_produk" id="id_transfer_produk" value="{{ old('id_transfer_produk', $transferProduk->id_transfer_produk) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_quality_control') ? 'is-invalid' : '' }}" name="id_quality_control_id" id="id_quality_control_id">
