    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.transfer-produks.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_transfer_produk') ? 'is-invalid' : '' }}" type="text" name="id_transfer_produk" id="id_transfer_produk" value="{{ old('id_transfer_produk', '') }}">
