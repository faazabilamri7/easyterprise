...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchas-reqs.update", [$purchasReq->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="id_list_of_material">{{ trans('cruds.purchasReq.fields.id_list_of_material') }}</label>
                <input class="form-control {{ $errors->has('id_list_of_material') ? 'is-invalid' : '' }}" type="number" name="id_list_of_material" id="id_list_of_material" value="{{ old('id_list_of_material', $purchasReq->id_list_of_material) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_purchase_requisition') ? 'is-invalid' : '' }}" type="text" name="date_purchase_requisition" id="date_purchase_requisition" value="{{ old('date_purchase_requisition', $purchasReq->date_purchase_requisition) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_price') ? 'is-invalid' : '' }}" type="number" name="total_price" id="total_price" value="{{ old('total_price', $purchasReq->total_price) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $purchasReq->status) }}">
