    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-nameMaterialPurchaseInqs">
                    <thead>
                        <tr>
                            <th width="10">
...
@endcan
  ...
  let table = $('.datatable-nameMaterialPurchaseInqs:not(.ajaxTable)').DataTable({ buttons: dtButtons })
