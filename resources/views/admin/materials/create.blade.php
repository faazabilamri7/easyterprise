    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.materials.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_material') ? 'is-invalid' : '' }}" type="text" name="name_material" id="name_material" value="{{ old('name_material', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('descriptive') ? 'is-invalid' : '' }}" name="descriptive" id="descriptive">{{ old('descriptive') }}</textarea>
