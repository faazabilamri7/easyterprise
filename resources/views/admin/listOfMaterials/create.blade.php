...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.list-of-materials.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="id_list_of_material">{{ trans('cruds.listOfMaterial.fields.id_list_of_material') }}</label>
                <input class="form-control {{ $errors->has('id_list_of_material') ? 'is-invalid' : '' }}" type="text" name="id_list_of_material" id="id_list_of_material" value="{{ old('id_list_of_material', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('id_production_plan') ? 'is-invalid' : '' }}" name="id_production_plan_id" id="id_production_plan_id">
                    @foreach($id_production_plans as $id => $entry)
                        <option value="{{ $id }}" {{ old('id_production_plan_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('request_air') ? 'is-invalid' : '' }}" type="number" name="request_air" id="request_air" value="{{ old('request_air', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('request_sukrosa') ? 'is-invalid' : '' }}" type="number" name="request_sukrosa" id="request_sukrosa" value="{{ old('request_sukrosa', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('request_dektrose') ? 'is-invalid' : '' }}" type="number" name="request_dektrose" id="request_dektrose" value="{{ old('request_dektrose', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('request_perisa_yakult') ? 'is-invalid' : '' }}" type="number" name="request_perisa_yakult" id="request_perisa_yakult" value="{{ old('request_perisa_yakult', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('request_susu_bubuk_krim') ? 'is-invalid' : '' }}" type="number" name="request_susu_bubuk_krim" id="request_susu_bubuk_krim" value="{{ old('request_susu_bubuk_krim', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('request_polietilena_tereftalat') ? 'is-invalid' : '' }}" type="number" name="request_polietilena_tereftalat" id="request_polietilena_tereftalat" value="{{ old('request_polietilena_tereftalat', '') }}" step="1">
