    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.list-of-materials.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tanggal_selesai') ? 'is-invalid' : '' }}" type="text" name="tanggal_selesai" id="tanggal_selesai" value="{{ old('tanggal_selesai') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pilihan_bahan_baku') ? 'is-invalid' : '' }}" type="text" name="pilihan_bahan_baku" id="pilihan_bahan_baku" value="{{ old('pilihan_bahan_baku', '') }}">
