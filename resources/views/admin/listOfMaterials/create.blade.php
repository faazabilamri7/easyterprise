    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.list-of-materials.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_list_of_material') ? 'is-invalid' : '' }}" type="text" name="id_list_of_material" id="id_list_of_material" value="{{ old('id_list_of_material', '') }}" required>
