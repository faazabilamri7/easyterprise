    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pengirimen.update", [$pengiriman->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_customer') ? 'is-invalid' : '' }}" type="text" name="nama_customer" id="nama_customer" value="{{ old('nama_customer', $pengiriman->nama_customer) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('alamat_pengiriman') ? 'is-invalid' : '' }}" name="alamat_pengiriman" id="alamat_pengiriman">{{ old('alamat_pengiriman', $pengiriman->alamat_pengiriman) }}</textarea>
