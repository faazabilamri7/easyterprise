    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.purchase-orders.update", [$purchaseOrder->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_purchase_order') ? 'is-invalid' : '' }}" type="text" name="id_purchase_order" id="id_purchase_order" value="{{ old('id_purchase_order', $purchaseOrder->id_purchase_order) }}">
