    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.akuns.update", [$akun->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="nama">{{ trans('cruds.akun.fields.nama') }}</label>
                            <input class="form-control" type="text" name="nama" id="nama" value="{{ old('nama', $akun->nama) }}">
                            @if($errors->has('nama'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="jenis_akun" id="jenis_akun" value="{{ old('jenis_akun', $akun->jenis_akun) }}">
