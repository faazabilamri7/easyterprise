    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.purchase-orders.update", [$purchaseOrder->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_purchase_order" id="date_purchase_order" value="{{ old('date_purchase_order', $purchaseOrder->date_purchase_order) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="material_name" id="material_name" value="{{ old('material_name', $purchaseOrder->material_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="quantity" id="quantity" value="{{ old('quantity', $purchaseOrder->quantity) }}" step="1">
