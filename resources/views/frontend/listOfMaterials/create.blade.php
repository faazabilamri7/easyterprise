                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.list-of-materials.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_list_of_material" id="id_list_of_material" value="{{ old('id_list_of_material', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="request_air" id="request_air" value="{{ old('request_air', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="request_sukrosa" id="request_sukrosa" value="{{ old('request_sukrosa', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="request_dektrose" id="request_dektrose" value="{{ old('request_dektrose', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="request_perisa_yakult" id="request_perisa_yakult" value="{{ old('request_perisa_yakult', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="request_susu_bubuk_krim" id="request_susu_bubuk_krim" value="{{ old('request_susu_bubuk_krim', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="request_polietilena_tereftalat" id="request_polietilena_tereftalat" value="{{ old('request_polietilena_tereftalat', '') }}" step="1">
