                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.list-of-materials.update", [$listOfMaterial->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tanggal_mulai" id="tanggal_mulai" value="{{ old('tanggal_mulai', $listOfMaterial->tanggal_mulai) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tanggal_selesai" id="tanggal_selesai" value="{{ old('tanggal_selesai', $listOfMaterial->tanggal_selesai) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pilihan_bahan_baku" id="pilihan_bahan_baku" value="{{ old('pilihan_bahan_baku', $listOfMaterial->pilihan_bahan_baku) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty" id="qty" value="{{ old('qty', $listOfMaterial->qty) }}" step="1" required>
                            @if($errors->has('qty'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="harga_satuan" id="harga_satuan" value="{{ old('harga_satuan', $listOfMaterial->harga_satuan) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="total" id="total" value="{{ old('total', $listOfMaterial->total) }}" required>
                            @if($errors->has('total'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('total') }}
                                </div>
