    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.customer-complains.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="keluhan" id="keluhan">{{ old('keluhan') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="kritik" id="kritik">{{ old('kritik') }}</textarea>
