    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.material-entries.update", [$materialEntry->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_material_entry" id="date_material_entry" value="{{ old('date_material_entry', $materialEntry->date_material_entry) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="material_name" id="material_name" value="{{ old('material_name', $materialEntry->material_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty" id="qty" value="{{ old('qty', $materialEntry->qty) }}" step="1">
                            @if($errors->has('qty'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty') }}
                                </div>
