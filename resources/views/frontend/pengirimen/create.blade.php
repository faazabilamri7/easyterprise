    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.pengirimen.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="nama_customer">{{ trans('cruds.pengiriman.fields.nama_customer') }}</label>
                            <input class="form-control" type="text" name="nama_customer" id="nama_customer" value="{{ old('nama_customer', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="alamat_pengiriman" id="alamat_pengiriman">{{ old('alamat_pengiriman') }}</textarea>
