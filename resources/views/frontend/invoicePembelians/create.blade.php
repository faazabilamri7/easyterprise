    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.invoice-pembelians.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="nomor">{{ trans('cruds.invoicePembelian.fields.nomor') }}</label>
                            <input class="form-control" type="number" name="nomor" id="nomor" value="{{ old('nomor', '') }}" step="1">
                            @if($errors->has('nomor'))
