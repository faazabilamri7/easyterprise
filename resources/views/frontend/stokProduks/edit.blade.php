    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.stok-produks.update", [$stokProduk->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="nama_produk">{{ trans('cruds.stokProduk.fields.nama_produk') }}</label>
                            <input class="form-control" type="text" name="nama_produk" id="nama_produk" value="{{ old('nama_produk', $stokProduk->nama_produk) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty" id="qty" value="{{ old('qty', $stokProduk->qty) }}" step="1">
                            @if($errors->has('qty'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="fotoproduk-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sku" id="sku" value="{{ old('sku', $stokProduk->sku) }}">
                            @if($errors->has('sku'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('sku') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="biaya_produksi" id="biaya_produksi" value="{{ old('biaya_produksi', $stokProduk->biaya_produksi) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="harga_jual" id="harga_jual" value="{{ old('harga_jual', $stokProduk->harga_jual) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\StokProduk::KATEGORI_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="kategori_{{ $key }}" name="kategori" value="{{ $key }}" {{ old('kategori', $stokProduk->kategori) === (string) $key ? 'checked' : '' }}>
                                    <label for="kategori_{{ $key }}">{{ $label }}</label>
                                </div>
                            @endforeach
...
<script>
    ...
    url: '{{ route('frontend.stok-produks.storeMedia') }}',
    maxFilesize: 2, // MB
