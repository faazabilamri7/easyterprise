        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.stokProduk.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.stok-produks.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="biaya_produksi" id="biaya_produksi" value="{{ old('biaya_produksi', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="harga_jual" id="harga_jual" value="{{ old('harga_jual', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\StokProduk::KATEGORI_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="kategori_{{ $key }}" name="kategori" value="{{ $key }}" {{ old('kategori', '') === (string) $key ? 'checked' : '' }}>
