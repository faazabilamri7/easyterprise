    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.chart-of-accounts.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="account_code">{{ trans('cruds.chartOfAccount.fields.account_code') }}</label>
                            <input class="form-control" type="text" name="account_code" id="account_code" value="{{ old('account_code', '') }}" required>
