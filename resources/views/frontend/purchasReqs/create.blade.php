    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.purchas-reqs.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="id_list_of_material">{{ trans('cruds.purchasReq.fields.id_list_of_material') }}</label>
                            <input class="form-control" type="number" name="id_list_of_material" id="id_list_of_material" value="{{ old('id_list_of_material', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_purchase_requisition" id="date_purchase_requisition" value="{{ old('date_purchase_requisition') }}">
