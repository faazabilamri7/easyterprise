                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sales-inquiries.update", [$salesInquiry->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="inquiry_kode" id="inquiry_kode" value="{{ old('inquiry_kode', $salesInquiry->inquiry_kode) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="nama_produk_id" id="nama_produk_id" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty" id="qty" value="{{ old('qty', $salesInquiry->qty) }}" step="1" required>
                            @if($errors->has('qty'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="catatan" id="catatan">{{ old('catatan', $salesInquiry->catatan) }}</textarea>
