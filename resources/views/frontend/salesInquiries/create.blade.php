    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sales-inquiries.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="inquiry_kode">{{ trans('cruds.salesInquiry.fields.inquiry_kode') }}</label>
                            <input class="form-control" type="text" name="inquiry_kode" id="inquiry_kode" value="{{ old('inquiry_kode', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tgl_inquiry" id="tgl_inquiry" value="{{ old('tgl_inquiry') }}" required>
