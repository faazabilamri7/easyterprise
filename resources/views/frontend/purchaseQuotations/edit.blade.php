                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.purchase-quotations.update", [$purchaseQuotation->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="material_name" id="material_name" value="{{ old('material_name', $purchaseQuotation->material_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $purchaseQuotation->status) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nego_purchase_quotation" id="nego_purchase_quotation" value="{{ old('nego_purchase_quotation', $purchaseQuotation->nego_purchase_quotation) }}">
