    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.request-for-quotations.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="id_purchase_requisition">{{ trans('cruds.requestForQuotation.fields.id_purchase_requisition') }}</label>
                            <input class="form-control" type="number" name="id_purchase_requisition" id="id_purchase_requisition" value="{{ old('id_purchase_requisition', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="id_company" id="id_company" value="{{ old('id_company', '') }}" step="1">
