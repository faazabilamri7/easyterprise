                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.request-for-quotations.update", [$requestForQuotation->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="id_purchase_requisition" id="id_purchase_requisition" value="{{ old('id_purchase_requisition', $requestForQuotation->id_purchase_requisition) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="id_company" id="id_company" value="{{ old('id_company', $requestForQuotation->id_company) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="material_name" id="material_name" value="{{ old('material_name', $requestForQuotation->material_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="quantity" id="quantity" value="{{ old('quantity', $requestForQuotation->quantity) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="unit_price" id="unit_price" value="{{ old('unit_price', $requestForQuotation->unit_price) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_price" id="total_price" value="{{ old('total_price', $requestForQuotation->total_price) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $requestForQuotation->status) }}">
