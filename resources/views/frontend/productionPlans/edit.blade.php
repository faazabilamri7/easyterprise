    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.production-plans.update", [$productionPlan->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="tugas">{{ trans('cruds.productionPlan.fields.tugas') }}</label>
                            <input class="form-control" type="text" name="tugas" id="tugas" value="{{ old('tugas', $productionPlan->tugas) }}" required>
                            @if($errors->has('tugas'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="tanggal_mulai" id="tanggal_mulai" value="{{ old('tanggal_mulai', $productionPlan->tanggal_mulai) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="durasi" id="durasi" value="{{ old('durasi', $productionPlan->durasi) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="rincian" id="rincian" value="{{ old('rincian', $productionPlan->rincian) }}">
