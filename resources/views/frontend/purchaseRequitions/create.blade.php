    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.purchase-requitions.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_1" id="qty_1" value="{{ old('qty_1', '') }}" step="1">
                            @if($errors->has('qty_1'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty_1') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_2" id="qty_2" value="{{ old('qty_2', '') }}" step="1">
                            @if($errors->has('qty_2'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty_2') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_3" id="qty_3" value="{{ old('qty_3', '') }}" step="1">
                            @if($errors->has('qty_3'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty_3') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_4" id="qty_4" value="{{ old('qty_4', '') }}" step="1">
                            @if($errors->has('qty_4'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty_4') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_5" id="qty_5" value="{{ old('qty_5', '') }}" step="1">
                            @if($errors->has('qty_5'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty_5') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="qty_6" id="qty_6" value="{{ old('qty_6', '') }}" step="1">
                            @if($errors->has('qty_6'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty_6') }}
                                </div>
