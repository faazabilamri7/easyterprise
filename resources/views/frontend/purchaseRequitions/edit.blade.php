                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.purchase-requitions.update", [$purchaseRequition->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_purchase_requition" id="id_purchase_requition" value="{{ old('id_purchase_requition', $purchaseRequition->id_purchase_requition) }}">
