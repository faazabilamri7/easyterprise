                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.quality-controls.update", [$qualityControl->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_quality_control" id="id_quality_control" value="{{ old('id_quality_control', $qualityControl->id_quality_control) }}" required>
