    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.kas-banks.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reff" id="reff" value="{{ old('reff', '') }}">
                            @if($errors->has('reff'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('reff') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="transaksi" id="transaksi" value="{{ old('transaksi', '') }}" step="0.01">
