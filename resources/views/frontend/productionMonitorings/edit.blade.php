                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.production-monitorings.update", [$productionMonitoring->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="id_production_monitoring" id="id_production_monitoring" value="{{ old('id_production_monitoring', $productionMonitoring->id_production_monitoring) }}">
