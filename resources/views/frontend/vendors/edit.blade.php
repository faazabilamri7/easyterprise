                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.vendors.update", [$vendor->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nama_vendor" id="nama_vendor" value="{{ old('nama_vendor', $vendor->nama_vendor) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="telepon" id="telepon" value="{{ old('telepon', $vendor->telepon) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="email" id="email" value="{{ old('email', $vendor->email) }}">
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="alamat" id="alamat" value="{{ old('alamat', $vendor->alamat) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="website" id="website" value="{{ old('website', $vendor->website) }}">
