                                    ...
                                    <tr data-entry-id="{{ $documentsVendor->id }}">
                                        ...
                                        <td>
                                            @can('documents_vendor_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.documents-vendors.show', $documentsVendor->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('documents_vendor_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.documents-vendors.edit', $documentsVendor->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('documents_vendor_delete')
                                                <form action="{{ route('frontend.documents-vendors.destroy', $documentsVendor->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('documents_vendor_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.documents-vendors.massDestroy') }}",
