                                    ...
                                    <tr data-entry-id="{{ $transferProduk->id }}">
                                        ...
                                        <td>
                                            @can('transfer_produk_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.transfer-produks.show', $transferProduk->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('transfer_produk_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.transfer-produks.edit', $transferProduk->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('transfer_produk_delete')
                                                <form action="{{ route('frontend.transfer-produks.destroy', $transferProduk->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('transfer_produk_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.transfer-produks.massDestroy') }}",
