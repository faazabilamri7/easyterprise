                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.purchase-inqs.update", [$purchaseInq->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_purchase_inquiry" id="date_purchase_inquiry" value="{{ old('date_purchase_inquiry', $purchaseInq->date_purchase_inquiry) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="material_name" id="material_name" value="{{ old('material_name', $purchaseInq->material_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="quantity" id="quantity" value="{{ old('quantity', $purchaseInq->quantity) }}" step="1">
