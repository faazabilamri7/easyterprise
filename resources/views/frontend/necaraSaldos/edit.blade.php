    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.necara-saldos.update", [$necaraSaldo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="tanggal">{{ trans('cruds.necaraSaldo.fields.tanggal') }}</label>
                            <input class="form-control date" type="text" name="tanggal" id="tanggal" value="{{ old('tanggal', $necaraSaldo->tanggal) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="debit" id="debit" value="{{ old('debit', $necaraSaldo->debit) }}" step="0.01">
                            @if($errors->has('debit'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('debit') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="kredit" id="kredit" value="{{ old('kredit', $necaraSaldo->kredit) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_debit" id="total_debit" value="{{ old('total_debit', $necaraSaldo->total_debit) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_kredit" id="total_kredit" value="{{ old('total_kredit', $necaraSaldo->total_kredit) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total" id="total" value="{{ old('total', $necaraSaldo->total) }}" step="0.01">
                            @if($errors->has('total'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('total') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', $necaraSaldo->status) }}">
