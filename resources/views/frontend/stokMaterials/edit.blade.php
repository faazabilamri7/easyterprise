    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.stok-materials.update", [$stokMaterial->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="nama_material">{{ trans('cruds.stokMaterial.fields.nama_material') }}</label>
                            <input class="form-control" type="text" name="nama_material" id="nama_material" value="{{ old('nama_material', $stokMaterial->nama_material) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qty" id="qty" value="{{ old('qty', $stokMaterial->qty) }}">
                            @if($errors->has('qty'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('qty') }}
                                </div>
